...
exports.getSpecialization = async (req, res) => {
    const specialization = await SpecializationService.getSpecialization(req.params.id);
...
exports.deleteSpecialization = async (req, res) => {
    const specialization = await SpecializationService.deleteSpecialization(req.params.id);
    res.send(specialization);
};
