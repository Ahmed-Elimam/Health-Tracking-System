...
const registerSchema = Joi.object({
  firstName: Joi.string()
    ...
    .required()
    .messages({
      'string.pattern.base': 'First name must be at least 2 characters long and contain only letters.',
  ...
  lastName: Joi.string()
    ...
    .required()
    .messages({
      'string.pattern.base': 'Last name must be at least 2 characters long and contain only letters.',
  ...
  phone: Joi.string()
    ...
    .required()
    .messages({
      'string.pattern.base': 'Invalid phone number. Must be a valid Egyptian number (e.g., 010, 011, 012, 015).',
